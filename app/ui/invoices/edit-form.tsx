...
customers: CustomerField[];
  ...
  const [state, dispatch] = useFormState(updateInvoiceWithId , initialState); //The dispatch function lets you update the state to a different value and trigger a re-render. 
